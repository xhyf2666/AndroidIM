...
public final class MImageUtil {
    ...
    /** Crops bitmap with given {@link Rect}. */
    ...
    private static byte[] yuvImageToJpegByteArray(ImageProxy image)
            throws EncodeFailedException {
        MImageUtil myImageUtil = new MImageUtil();
        return myImageUtil.nv21ToJpeg(
                myImageUtil.yuv_420_888toNv21(image),
                image.getWidth(),
                image.getHeight(),
